...
export function SettingsPage() {
  ...
  const handleClearHistory = () => {
    if (
      window.confirm(
        'Are you sure you want to delete all local chat history? This action is irreversible.'
      )
    ) {
  ...
  return (
    <div className="relative overflow-hidden bg-background-light dark:bg-background-dark min-h-screen text-gray-800 dark:text-gray-200">
      ...
      <div className="absolute inset-0 opacity-40 pointer-events-none">
        ...
        <div
          className="absolute bottom-10 right-10 w-80 h-80 bg-blue-800/10 dark:bg-blue-800/5 rounded-full filter blur-[100px] animate-pulse"
      ...
      <div className="app-container relative z-10 py-12 max-w-4xl">
        ...
        <div className="mb-10 pb-4 border-b border-gray-150 dark:border-gray-850">
          ...
          <p className="text-gray-650 dark:text-gray-400 text-sm mt-1">
            Configure underlying environment models, audit toast notification
            systems, and manage active session storage properties.
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white/70 dark:bg-gray-950/40 backdrop-blur-md rounded-2xl border border-gray-150 dark:border-gray-850 p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-6 pb-4 border-b border-gray-150 dark:border-gray-850/60">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                  Test real-time toast alert dispatches and system responses.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <button
                onClick={() =>
                  showToast('Failed to connect to local API server.', 'error')
                }
              ...
              <button
                onClick={() =>
                  showToast(
                    'High liability found in Intellectual Property clause.',
                    'warning'
                  )
                }
              ...
              <button
                onClick={() =>
                  showToast('AI Sandbox loaded with local context.', 'info')
                }
            ...
            <div className="mt-4 pt-4 border-t border-gray-150 dark:border-gray-850/60">
              <button
                onClick={() => {
                  ...
                  setTimeout(
                    () => showToast('Analyzing structure...', 'warning'),
                    600
                  );
                  setTimeout(
                    () =>
                      showToast(
                        'Liabilities extracted successfully!',
                        'success'
                      ),
                    1200
                  );
          ...
          <div className="bg-white/70 dark:bg-gray-950/40 backdrop-blur-md rounded-2xl border border-gray-150 dark:border-gray-850 p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-5 pb-4 border-b border-gray-150 dark:border-gray-850/60">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                  Customize default visualization palettes and theme alignments.
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center p-4 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-950/20">
              <div>
                <p className="text-xs font-bold uppercase tracking-wider text-gray-800 dark:text-gray-250">
                  Theme Mode
                </p>
                <p className="text-xs text-gray-550 dark:text-gray-400 mt-1">
                  Switch between light and dark backgrounds utilizing the theme
                  toggle located in the main header panel.
                </p>
              </div>
          ...
          <div className="bg-white/70 dark:bg-gray-950/40 backdrop-blur-md rounded-2xl border border-gray-150 dark:border-gray-850 p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-5 pb-4 border-b border-gray-150 dark:border-gray-850/60">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                  Manage data retention and delete local storage entries.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-4 rounded-xl border border-red-500/15 bg-red-500/5 dark:bg-red-950/10">
              <div className="max-w-md">
                ...
                <p className="text-xs text-gray-550 dark:text-gray-400 mt-1">
                  Irreversibly delete all saved chat history messages from local
                  cache storage.
                </p>
              </div>
              <button
          ...
          <div className="bg-white/70 dark:bg-gray-950/40 backdrop-blur-md rounded-2xl border border-gray-150 dark:border-gray-850 p-6 md:p-8 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-5 pb-4 border-b border-gray-150 dark:border-gray-850/60">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                  Set display languages and align reporting dates.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-[10px] font-extrabold uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-2">
                  Display Language Selection
                </label>
                <select
                  onChange={(e) =>
                    showToast(
                      `System display language aligned to ${e.target.value}`,
                      'info'
                    )
                  }
