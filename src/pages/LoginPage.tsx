...
export function LoginPage() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-950 dark:via-[#09090b] dark:to-[#020205]">
      ...
      <div className="relative w-full max-w-md p-8 md:p-10 rounded-[32px] bg-white/70 dark:bg-white/[0.02] backdrop-blur-2xl border border-gray-200/50 dark:border-white/[0.05] shadow-2xl transition-all duration-300">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Sign in to securely manage and parse your documents</p>
        </div>
          ...
          <div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 text-sm rounded-2xl border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/[0.02] text-gray-950 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-11 pr-12 py-3 text-sm rounded-2xl border border-gray-200 dark:border-white/10 bg-white/50 dark:bg-white/[0.02] text-gray-950 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200"
              />
              <button
                type="button"
        ...
        <div className="mt-8 text-center text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200/50 dark:border-white/[0.05] pt-6">
          New to LegalEase?{' '}
          <NavLink to="/signup" className="font-semibold text-primary hover:underline">
            Create an account
          </NavLink>
        </div>
      </div>
