import { Send, User, Bot, Paperclip, X, FileText, Sparkles, RefreshCcw, PlusCircle, Trash2, History, Copy, Check, ShieldCheck, Pencil, ChevronLeft, ChevronRight } from 'lucide-react';
