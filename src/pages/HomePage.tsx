...
const DEMO_CLAUSES: Readonly<Record<'term' | 'indem' | 'ip', DemoClause>> =
  Object.freeze({
    term: {
      title: 'Termination Clause',
      original:
        'This Agreement may be terminated by either party upon thirty (30) days prior written notice; provided, however, that Company may terminate this Agreement immediately without notice or penalty in the event of any breach of confidentiality by Contractor.',
      aiAnalysis:
        'UNBALANCED RISK: The immediate termination option without notice or penalty is highly unilateral and only benefits the Company. Contractor is not granted reciprocal rights.',
      risk: 'High Risk',
      riskColor:
        'text-red-650 bg-red-500/10 border-red-500/20 dark:text-red-500',
      remediation:
        'Negotiate a reciprocal 7-day cure period for any breach of confidentiality before immediate termination can take place.',
    },
    indem: {
      title: 'Indemnification Clause',
      original:
        "Contractor agrees to defend, indemnify, and hold harmless the Company and its affiliates from and against any and all claims, liabilities, losses, damages, costs, and expenses (including reasonable attorneys' fees) arising out of or related to Contractor's performance of services.",
      aiAnalysis:
        "BROAD LIABILITY: The clause covers 'any and all claims' arising out of performance, regardless of fault or negligence by the Contractor.",
      risk: 'Medium Risk',
      riskColor:
        'text-amber-650 bg-amber-500/10 border-amber-500/20 dark:text-amber-500',
      remediation:
        "Limit indemnification solely to third-party claims arising directly from the Contractor's gross negligence or willful misconduct.",
    },
    ip: {
      title: 'Intellectual Property Clause',
      original:
        'All deliverables, materials, inventions, and work product developed or prepared by Contractor in the performance of services under this Agreement shall belong solely and exclusively to the Company, and Contractor hereby assigns all intellectual property rights therein.',
      aiAnalysis:
        'FULL TRANSFER: Complete transfer of all developed work. Pre-existing materials are not explicitly carved out.',
      risk: 'Low Risk',
      riskColor:
        'text-blue-650 bg-blue-500/10 border-blue-500/20 dark:text-blue-500',
      remediation:
        "Add a clear 'Pre-Existing IP' clause to protect and exclude your proprietary background libraries or tools from automatic assignment.",
    },
  });
...
export function HomePage() {
  const [activeDemoClause, setActiveDemoClause] = useState<
    'term' | 'indem' | 'ip'
  >('term');
    ...
    <div className="overflow-hidden bg-background-light dark:bg-background-dark text-gray-800 dark:text-gray-200">
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50/50 via-indigo-50/20 to-emerald-50/20 dark:from-gray-900 dark:via-gray-950 dark:to-blue-950 text-gray-900 dark:text-white overflow-hidden border-b border-gray-200/80 dark:border-gray-800">
        ...
        <div className="absolute inset-0 opacity-40">
          ...
          <div
            className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-blue-800/10 dark:bg-blue-800 rounded-full filter blur-[70px] dark:blur-[100px] animate-pulse"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 text-center lg:text-left">
              ...
              <p className="text-lg text-gray-650 dark:text-gray-300 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Stop drowning in complex legal jargon. Instantly upload
                agreements, NDA contracts, and leases to audit liabilities,
                identify high-risk clauses, and generate plain-English summaries
                instantly.
              </p>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800/60 text-left">
                ...
                <div className="flex flex-wrap gap-x-8 gap-y-4 justify-center lg:justify-start items-center opacity-65 dark:opacity-50 grayscale hover:opacity-90 transition-opacity">
                  <div className="flex items-center gap-1.5 font-bold text-sm tracking-tight text-gray-800 dark:text-white">
                    <Scale size={16} /> LexPartners
                  </div>
                  <div className="flex items-center gap-1.5 font-bold text-sm tracking-tight text-gray-800 dark:text-white">
                    <Shield size={16} /> SecureTrust
                  </div>
                  <div className="flex items-center gap-1.5 font-bold text-sm tracking-tight text-gray-800 dark:text-white">
                    <Lock size={16} /> Encrypta
                  </div>
                  <div className="flex items-center gap-1.5 font-bold text-sm tracking-tight text-gray-800 dark:text-white">
                    <CheckCircle2 size={16} /> Compliancy
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative mx-auto max-w-[450px] lg:max-w-none rounded-2xl border border-gray-250 dark:border-gray-800 bg-white dark:bg-gray-950/80 p-1.5 backdrop-blur-md shadow-xl dark:shadow-2xl shadow-blue-100/50 dark:shadow-blue-900/20">
                ...
                <div className="flex items-center justify-between px-4 py-2 border-b border-gray-200 dark:border-b-gray-800/80 text-xs text-gray-500 dark:text-gray-405">
                  ...
                  <div className="font-mono text-[10px] bg-gray-100 dark:bg-gray-900 border border-gray-200 dark:border-transparent px-2 py-0.5 rounded text-primary-700 dark:text-primary-400">
                    AI-CLAUSE-ANALYZER.EXE
                  </div>
                </div>
                ...
                <div className="p-4 space-y-4 text-left">
                  ...
                  <div className="space-y-2 bg-gray-50 dark:bg-gray-900/90 rounded-xl p-4 border border-gray-200 dark:border-gray-850">
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${DEMO_CLAUSES[activeDemoClause].riskColor}`}
                      >
                    ...
                    <div className="pt-2.5 border-t border-gray-200 dark:border-gray-850">
                      <span className="text-[9px] uppercase font-bold tracking-wider text-amber-600 dark:text-amber-500 block mb-1">
                        Recommended Action
                      </span>
        ...
        <div className="app-container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="p-4 bg-white dark:bg-gray-800 rounded-2xl border border-gray-150 dark:border-gray-700 shadow-sm hover:scale-105 transition-all">
              <span className="text-3xl font-extrabold text-primary-600 dark:text-primary-400 block">
                99.4%
              </span>
            ...
            <div className="p-4 bg-white dark:bg-gray-800 rounded-2xl border border-gray-150 dark:border-gray-700 shadow-sm hover:scale-105 transition-all">
              <span className="text-3xl font-extrabold text-blue-600 dark:text-blue-400 block">
                SOC-2
              </span>
              <span className="text-xs font-semibold text-gray-400 dark:text-gray-400 uppercase tracking-wider">
                Certified Secure
        ...
        <div className="app-container">
          <div className="text-center mb-20">
            ...
            <p className="text-gray-650 dark:text-gray-450 max-w-2xl mx-auto text-base">
              Say goodbye to manual document parsing and high legal auditing
              consulting bills. Our suite of AI algorithms reviews your files
              instantly.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group relative p-8 rounded-2xl bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden text-left">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">
                Cognitive Contract Audit
              </h3>
              <p className="text-sm leading-relaxed text-gray-650 dark:text-gray-400">
                Extract hidden risks, uncapped liabilities, and non-standard
                indemnification triggers immediately. Clear plain-language
                insights in seconds.
              </p>
            </div>
            ...
            <div className="group relative p-8 rounded-2xl bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden text-left">
              ...
              <p className="text-sm leading-relaxed text-gray-650 dark:text-gray-400">
                Your data is protected by AES-256 bank-level encryption. All
                operations adhere strictly to GDPR, HIPAA, and custom workspace
            ...
            <div className="group relative p-8 rounded-2xl bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden text-left">
              ...
              <p className="text-sm leading-relaxed text-gray-650 dark:text-gray-400">
                Chat interactively with our specialized legal AI. Ask direct
                questions, request summaries of subclauses, or craft alternative
                balance proposals.
              </p>
            </div>
            ...
            <div className="group relative p-8 rounded-2xl bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden text-left">
              ...
              <p className="text-sm leading-relaxed text-gray-650 dark:text-gray-400">
                Contracts are parsed and classified with a composite risk index,
                giving you immediate clarity on which documents require manual
                legal team reviews.
              </p>
            </div>
            ...
            <div className="group relative p-8 rounded-2xl bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden text-left">
              ...
              <p className="text-sm leading-relaxed text-gray-650 dark:text-gray-400">
                Upload legal documents drafted in English, Spanish, German,
                French, or Japanese. Summarize and interact with them in your
                language of choice.
              </p>
            </div>
            ...
            <div className="group relative p-8 rounded-2xl bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden text-left">
              ...
              <p className="text-sm leading-relaxed text-gray-650 dark:text-gray-400">
                Compare client markups against your master agreement templates
                in a side-by-side diff dashboard, highlighting deviations in
                legal language.
              </p>
            </div>
          </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-950 border-t border-gray-150 dark:border-gray-900">
        <div className="app-container">
          <div className="text-center mb-20">
            ...
            <div className="h-1.5 w-20 bg-primary-600 mx-auto rounded-full mb-6"></div>
            <p className="text-gray-650 dark:text-gray-450 max-w-2xl mx-auto text-base">
              Our intelligent legal parsing engine provides specialized
              security, risk analysis, and contract transparency for every legal
              stakeholder.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-sm leading-relaxed text-gray-605 dark:text-gray-400">
                Automate due diligence, rapidly audit compliance across massive
                portfolios, and flag high-liability clauses in seconds instead
                of hours.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-sm leading-relaxed text-gray-655 dark:text-gray-400">
                Standardize contract terms, ensure enterprise-wide compliance,
                and accelerate internal sales/procurement deal cycles with
            ...
            >
              ...
              <p className="text-sm leading-relaxed text-gray-655 dark:text-gray-400">
                Fast-track investment term sheets, vendor service agreements,
                and partner contracts without early-stage high legal
                consultation costs.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-sm leading-relaxed text-gray-655 dark:text-gray-400">
                Demystify complex client NDAs, protect your intellectual
                property rights, and clearly audit payment and termination
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 relative flex justify-center">
              ...
              <div className="border border-gray-200 dark:border-gray-700/80 bg-white dark:bg-gray-900/80 rounded-2xl p-8 max-w-sm relative z-10 backdrop-blur-md text-left">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                  We leverage local sandbox extraction pipelines to analyze
                  files. Your contracts never end up saved in generic cloud
                  training corpora.
                </p>
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 text-[11px] text-gray-700 dark:text-gray-300 font-semibold">
                    <CheckCircle2
                      ...
                      className="text-emerald-600 dark:text-emerald-400"
                    />{' '}
                    Isolated API Sandbox Pipelines
                  </div>
                  <div className="flex items-center gap-2 text-[11px] text-gray-700 dark:text-gray-300 font-semibold">
                    <CheckCircle2
                      size={12}
            ...
            <div className="lg:col-span-7 text-left">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
                Unlike generic LLM platforms that scrape prompts to feed their
                neural network iterations, LegalEase enforces strict isolation
                protocols. Each workspace is sandboxed, safeguarding your firm’s
                litigation briefs and proprietary agreements from leakage.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div className="flex items-start gap-3">
                  <div className="p-2 bg-gray-100 dark:bg-gray-900 rounded-lg text-primary-600 dark:text-primary-400 mt-1">
                    <Shield size={16} />
                  </div>
                  <div>
                    <h5 className="font-semibold text-sm mb-1 text-gray-900 dark:text-white">
                      Full Compliance
                    </h5>
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      Fully compliant with international GDPR and HIPAA
                      regulations.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      Secure user authentication limits file visibility strictly
                      to designated team nodes.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="app-container max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-xl mx-auto text-sm">
              Everything you need to know about LegalEase's underlying
              intelligence, billing safeguards, and data protection.
            </p>
          </div>
