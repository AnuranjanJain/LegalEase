...
function notifTypeLabel(type: AppNotification['type']) {
  if (type === 'document')
    return {
      ...
      cls: 'bg-blue-50 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 border border-blue-500/10',
    };
  if (type === 'security')
    return {
      label: 'Security',
      icon: <Shield size={13} />,
      cls: 'bg-amber-50 text-amber-600 dark:bg-amber-900/30 dark:text-amber-400 border border-amber-500/10',
    };
  return {
    label: 'System',
    icon: <Info size={13} />,
    cls: 'bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400 border border-transparent',
  };
}
  ...
  return (
    <button
      ...
      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-all duration-300 focus:outline-none ${
        checked
          ? 'bg-primary-600 shadow-[0_0_10px_rgba(37,99,235,0.3)]'
...
function Field({
  ...
  return (
    <div className="space-y-2">
      <label className="text-[10px] font-extrabold uppercase tracking-widest text-gray-400 dark:text-gray-500 block">
        {label}
      </label>
      {children}
    </div>
...
const inputCls =
  'w-full bg-gray-50/50 dark:bg-gray-950/20 border border-gray-200 dark:border-gray-800 rounded-xl px-4 py-3 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/20 focus:border-primary/60 transition-all outline-none';
const readOnlyCls =
  'w-full bg-gray-100 dark:bg-gray-900/60 border border-gray-200 dark:border-gray-800 rounded-xl px-4 py-3 text-sm text-gray-500 dark:text-gray-400 cursor-not-allowed outline-none';
...
export function ProfilePage() {
  ...
  const [timezone, setTimezone] = useState(
    profile.preferences.timezone || 'EST'
  );
  ...
  const section: Section = VALID_TABS.includes(tab as Section)
    ? (tab as Section)
    : 'profile';
  ...
  const updateNotificationPref = (
    ...
    const newProfile = { ...profile };
    newProfile.preferences.notifications[key] =
      !newProfile.preferences.notifications[key];
    setProfile(newProfile);
  };
  ...
  return (
    <div className="relative overflow-hidden bg-background-light dark:bg-background-dark min-h-screen text-gray-800 dark:text-gray-200">
      ...
      <div className="absolute inset-0 opacity-40 pointer-events-none">
        ...
        <div
          className="absolute bottom-10 left-10 w-80 h-80 bg-blue-800/10 dark:bg-blue-800/5 rounded-full filter blur-[100px] animate-pulse"
          ...
          <div className="flex-grow p-8 md:p-12 overflow-y-auto">
            ...
            {section === 'profile' && (
              <div className="space-y-8 animate-slide-up">
                <SectionHeader
                  ...
                  subtitle="Update your personal identification info, public details, and bios."
                />
                ...
                <div className="pt-6 border-t border-gray-150 dark:border-gray-850 flex justify-end gap-4">
                  <button
                    ...
                    className="px-5 py-2.5 text-xs font-bold text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
                  >
                    Discard Changes
                  </button>
                  <button
            ...
            {section === 'security' && (
              <div className="space-y-8 max-w-xl animate-slide-up">
                <SectionHeader
                  ...
                  subtitle="Manage sign-in credentials, multi-factor triggers, and audit active sessions."
                />
                ...
                <div className="space-y-4">
                    ...
                    return (
                      <div key={field} className="relative">
                        ...
                        <button
                          ...
                          aria-label={
                            showPw[field] ? 'Hide password' : 'Show password'
                          }
                        >
                          {showPw[field] ? (
                            <EyeOff size={16} />
                  ...
                  <p className="text-[10px] text-gray-400 dark:text-gray-500">
                    Must be at least 8 characters long, featuring numbers,
                    symbols, and uppercase variables.
                  </p>
                ...
                <div className="border-t border-gray-150 dark:border-gray-850 pt-8 space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      Strengthen access layers with TOTP tokens generated by
                      secure authenticator apps.
                    </p>
                  </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-550 dark:text-gray-400">
                          {twoFa ? 'Protected — active' : 'Not configured'}
                        </p>
                      </div>
                    </div>
                    <Toggle
                      ...
                      label="Toggle 2FA app verification"
                    />
                  </div>
                </div>
                ...
                <div className="border-t border-gray-150 dark:border-gray-850 pt-8 space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      Inspect and manage active workspace visibility channels.
                    </p>
                  </div>
                  ...
                  {[
                    ...
                    <div
                      key={session.device}
                      className="flex items-center justify-between p-4 rounded-xl border border-gray-200 dark:border-gray-800 bg-white/40 dark:bg-gray-950/10 hover:shadow-sm transition-all"
                    >
                      <div className="flex items-center gap-3">
                      ...
                      {session.current ? (
                        <span className="text-[10px] font-bold px-2.5 py-1 rounded-full bg-primary-600/10 text-primary border border-primary/20">
                          Current Node
                        </span>
                      ) : (
                        <button
            ...
            {section === 'notifications' && (
              <div className="space-y-8 max-w-2xl animate-slide-up">
                <SectionHeader
                  title="Alert Filters"
                  subtitle="Configure notification vectors for secure compliance audits, document actions, and security reviews."
                />

                <div>
                  <h4 className="text-xs font-extrabold uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-3">
                    ...
                    {[
                      {
                        ...
                        title: 'Document analysis pipelines',
                        desc: 'Get updates on completed AI contract audits, risk scores, and summary generations.',
                      },
                      {
                        key: 'security' as const,
                        title: 'Security audit events',
                        desc: 'Alerts regarding logins, profile edits, session activations, and key additions.',
                      },
                      {
                        key: 'marketing' as const,
                        title: 'Product intelligence digests',
                        desc: 'Brief highlights of new legal parsing models, features, and platform updates.',
                      },
                    ].map(({ key, title, desc }) => (
                      <div
                        key={key}
                        className="flex items-center justify-between px-5 py-4 bg-white/40 dark:bg-gray-900/30"
                      >
                        <div className="pr-4">
                        ...
                        <Toggle
                          checked={profile.preferences.notifications[key]}
                          onChange={() => updateNotificationPref(key)}
                          label={`Toggle ${title}`}
                        />
                      </div>
                    ))}
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-primary-600 text-white rounded-xl text-xs font-bold hover:shadow-lg hover:shadow-primary-500/20 active:scale-95 transition-all"
                >
                ...
                <div className="border-t border-gray-150 dark:border-gray-850 pt-8">
                  ...
                  {notifications.length === 0 ? (
                    <div className="text-center py-12 border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-xl">
                      <Bell
                        size={24}
                        className="mx-auto text-gray-300 dark:text-gray-650 mb-2 animate-bounce"
                      />
                      <p className="text-sm font-semibold text-gray-400">
                        Your notifications tray is clear
                      </p>
                    </div>
                  ) : (
                    <div className="divide-y divide-gray-150 dark:divide-gray-850 border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden bg-white/20 dark:bg-gray-900/10">
                      {notifications.map((n) => {
                        ...
                        return (
                          <div
                            key={n.id}
                            className={`flex items-start gap-4 px-5 py-4 transition-colors ${!n.read ? 'bg-primary-600/5 dark:bg-primary-500/5' : 'bg-transparent'}`}
                          >
                            <div className="mt-0.5 flex-shrink-0">
                              <span
                                className={`inline-flex items-center gap-1 text-[10px] font-bold px-2 py-0.5 rounded-full ${cls}`}
                              >
                                {icon}
                                {label}
                              </span>
                            ...
                            <div className="flex-1 min-w-0">
                              <p
                                className={`text-sm font-bold leading-normal ${!n.read ? 'text-gray-950 dark:text-white' : 'text-gray-700 dark:text-gray-300'}`}
                              >
                                {n.title}
                              </p>
            ...
            {section === 'language' && (
              <div className="space-y-8 max-w-2xl animate-slide-up">
                <SectionHeader
                  title="Localization Profiles"
                  subtitle="Select default interface display languages and align reporting time zones."
                />
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {LANGUAGES.map((lang) => (
                      ...
                      >
                        <div>
                          <p
                            className={`text-sm font-bold ${selectedLang === lang.code ? 'text-primary' : 'text-gray-900 dark:text-gray-200'}`}
                          >
                            {lang.name}
                          </p>
                ...
                <div className="pt-2 flex justify-end">
                  <button
                    ...
                    className="px-8 py-3 bg-primary-600 text-white rounded-xl text-xs font-bold hover:shadow-lg hover:shadow-primary-500/20 active:scale-95 transition-all"
                  >
