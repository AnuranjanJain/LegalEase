      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-12">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center space-x-5">
            <a href="https://x.com/legalease" target="_blank" rel="noopener noreferrer" aria-label="X"
            ...
            <a href="https://linkedin.com/company/legalease" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
              className="text-gray-400 dark:text-white/30 hover:text-gray-900 dark:hover:text-white transition-colors">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
